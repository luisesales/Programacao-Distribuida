...
import com.bankai.mcp.client.prompt.DocumentReader;

import io.modelcontextprotocol.client.McpSyncClient;

@SpringBootApplication
@EnableDiscoveryClient
public class BankaiMcpClientApplication {

	public static void main(String[] args) {
		SpringApplication.run(BankaiMcpClientApplication.class, args);
	}
